...
@Service
public class GetWeeklyRecommendationsUseCase {

    private final TeacherRepository teacherRepository;

    public GetWeeklyRecommendationsUseCase(TeacherRepository teacherRepository) {
        this.teacherRepository = teacherRepository;
    }

    @Cacheable(value = "weeklyRecommendations", key = "#cityCode + ':' + #limit", unless = "#result.isEmpty()")
